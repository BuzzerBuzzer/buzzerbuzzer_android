...
public class GroupChatFragment extends Fragment {//채팅안
    ...
    private TextView mCurrentEventText, yourname;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        chat_screen = (LinearLayout) rootView.findViewById(R.id.chat_screen);
        ...
        yourname = (TextView) rootView.findViewById(R.id.yourname);
        btn_back_chat = (ImageView) rootView.findViewById(R.id.btn_back_chat);
        ...
        im = (InputMethodManager) getActivity().getSystemService(Activity.INPUT_METHOD_SERVICE);
        ...
        mRecyclerView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("테스트", "mRecyclerView");
            }
        });
        mCurrentEventLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("테스트", "mCurrentEventLayout");
            }
        });
        mCurrentEventText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("테스트", "mCurrentEventText");
            }
        });
...
*/
        ...
        chat_screen.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                //Toast.makeText(getActivity(), "hideKeyboard", Toast.LENGTH_LONG).show();
                //imm.hideSoftInputFromWindow(mMessageEditText.getWindowToken(), 0);
                im.hideSoftInputFromWindow(chat_screen.getWindowToken(), 0);
                Log.d("테스트", "GroupChatFragment test1");
    ...
    public void chatprofile(String id){
        ...
        Intent intentfr = new Intent(getContext(), Chatprofile.class);
