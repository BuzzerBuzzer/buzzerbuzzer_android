...
import com.movements.and.buzzerbuzzer.Withdraw;
...
public class GroupChannelListFragment extends Fragment {//리스트
    ...
    private String TAG = "GroupChannelListFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Log.e("LIFECYCLE", "GroupChannelListFragment onCreateView()");
...
//        ((GroupChannelActivity) getActivity()).setActionBarTitle("Group Channels");
        ...
        mChannelListAdapter.setHasStableIds(true);
...
//        });
    ...
    private void setUpRecyclerView() {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                Log.e(TAG, "setUpRecyclerView1");
                if (mLayoutManager.findLastVisibleItemPosition() == mChannelListAdapter.getItemCount() - 1) {
                    Log.e(TAG, "setUpRecyclerView2");
                    loadNextChannelList();
                }
            }
        });
    ...
    private void setUpChannelListAdapter() {
        mChannelListAdapter.setOnItemClickListener(new GroupChannelListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(GroupChannel channel) {
                Log.e(TAG, "setUpChannelListAdapter1");
        ...
        mChannelListAdapter.setOnItemLongClickListener(new GroupChannelListAdapter.OnItemLongClickListener() {
            ...
            public void onItemLongClick(final GroupChannel channel) {
                Log.e(TAG, "setUpChannelListAdapter2");
    ...
    private void showChannelOptionsDialog(final GroupChannel channel) {
        ...
        Log.d(TAG+"개", String.valueOf(pushCurrentlyEnabled));
        options = pushCurrentlyEnabled
                ? new String[]{"채팅방 나가기", "알람끄기"}
                : new String[]{"채팅방 나가기", "알람켜기"};
                ...
                .setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (which == 0) {
                            ...
                            Log.d("개1", channel+"  :  "+String.valueOf(!pushCurrentlyEnabled));
                        }
                    }
                });
        builder.create().show();
    ...
    void enterGroupChannel(String channelUrl) {
        ...
        getFragmentManager().beginTransaction()
                .replace(R.id.container_group_channel2, fragment)
                .addToBackStack(null)
                .commit();
    }
    ...
    private void refreshChannelList(int numChannels) {
        ...
        Log.e(TAG+" ,refreshChannelList", String.valueOf(numChannels));
        ...
        mChannelListQuery.next(new GroupChannelListQuery.GroupChannelListQueryResultHandler() {
            ...
            public void onResult(List<GroupChannel> list, SendBirdException e) {
                ...
                for (GroupChannel channel : list) {
                    Log.e("로드넥스트채널리스트", "프래그먼트");
                    mChannelListAdapter.addLast(channel);
                }

                Log.e(TAG +" 체널 수", String.valueOf(list.size()));
            }
        });
    }
