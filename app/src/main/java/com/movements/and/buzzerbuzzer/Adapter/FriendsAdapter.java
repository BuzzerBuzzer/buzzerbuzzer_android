...
//                    holder.crpv.setFgColorStart(Color.parseColor("#ff69b4"));
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Friend friends, final FriendsAdapter.RecyclerItemClickListener listener) {//RecyclerItemClickListener 추가후 4
            itemView.setClickable(true);
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    listener.onClickListener(friends, getLayoutPosition());
                    // Log.e("FriendsAdapter ","   6666");
                }
            });
